    ...
    def init(self, start=500, end=2000):
        ...
        if setting <= 0.4:
            ...
            self.image = pygame.transform.scale(
                pygame.image.load("assets/iron.png"), (150, 75))
            bottom = HEIGHT - 5
            ...
            self.type = "tan"
            self.image = pygame.transform.scale(
                pygame.image.load("assets/tan.png"), (100, 100))
            bottom = HEIGHT - 50

        elif setting <= 0.98:
            self.type = "anticarbon"
            self.image = pygame.transform.scale(
                pygame.image.load("assets/anticarbon.png"), (100, 100))
            bottom = HEIGHT - 50

        else:
            self.type = "nuclear"
            self.image = pygame.transform.scale(
                pygame.image.load("assets/nuclear.png"), (150, 75))
            bottom = HEIGHT - 50
